...
sample = cv2.imread(
    "C:/Users/ZINGSA-LAB/Desktop/ZCHPC_AFIS/dataset/Real/5__M_Left_little_finger.BMP"
)

best_score = counter = 0
filename = image = kp1 = kp2 = mp = None
for file in os.listdir("C:/Users/ZINGSA-LAB/Desktop/ZCHPC_AFIS/dataset/Real/"):
    if counter % 10 == 0:
        print(counter)
        print(file)
    counter += 1

    fingerprint_img = cv2.imread("C:/Users/ZINGSA-LAB/Desktop/ZCHPC_AFIS/dataset/Real/" + file)
